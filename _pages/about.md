...
I have published over <span id='num_total'>NA</span> papers including top-tier journals and conferences such as IEEE TMC, IEEE TKDE, ACM TOIS, ACM IMWUT, IEEE INFOCOM, and WWW (including <span id='num_ccfa' onload='countPapers()'>NA</span> <span class="ccfa_inline">CCF-A</span>, <span id='num_ccfb'>NA</span> <span class="ccfb_inline">CCF-B</span>, and <span id='num_jcr1'>NA</span> <span class="jcrq1_inline">JCR-Q1</span>). 
