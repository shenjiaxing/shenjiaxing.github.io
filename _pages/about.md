...
I have published over <span id='num_total'>NA</span> papers including top-tier journals and conferences such as IEEE TMC, IEEE TKDE, ACM TOIS, ACM IMWUT, IEEE INFOCOM, and WWW (including <span id='num_ccfa' onload='countPapers()'>NA</span> <span class="ccfa_inline">CCF-A</span>, 
<!-- <span id='num_ccfb'>NA</span> <span class="ccfb_inline">CCF-B</span>,  -->
...
- 📌 Recruiting self-motivated research students who are interested in doing MPhil and Ph.D. Feel free to drop me an email if you are interested in Human Dynamics research.
